 ...
 */
public class WeatherDetectorPeripheral implements IPeripheral {
     ...
     */
    private final WeatherDetector_TileEntity tileEntity;

    /**
     * @param tileEntity the tile entity of this peripheral
     */
    public WeatherDetectorPeripheral(WeatherDetector_TileEntity tileEntity) {
    ...
    public WeatherDetector_TileEntity getTileEntity() {
        return tileEntity;
    }
    ...
    @LuaFunction(mainThread = true)
    public final boolean isThundering() {return getTileEntity().getLevel().getThunderLevel(0) > 0;}
}
