...
public class ChatBoxPeripheral implements IPeripheral {
     ...
     */
    private final Chatbox_TileEntity tileEntity;

    /**
     * @param tileEntity the tile entity of this peripheral
     */
    public ChatBoxPeripheral(Chatbox_TileEntity tileEntity) {
    ...
    public Chatbox_TileEntity getTileEntity() {
        return tileEntity;
    }
